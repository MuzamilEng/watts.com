...
import { building_survey } from '../Data'
  ...
  return (
    <>
      <div className="bg-[#fff] overflow-x-hidden">
        {building_survey?.map((item, index) => (
                ...
                <div className="flex -mt-[12rem] p-4 ml-[10rem]">
                  ...
                  <div className="ml-[15rem] mt-[18rem]">
                    <p className='w-full max-w-[30rem] res_Lpara_width text-xl lg:text-3xl text-blue-600'>
                      This list is not exhaustive lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.
                    </p> <br />
                    <span className='text-blue-600 cursor-pointer text-xl font-semibold mt-[2rem] lg:text-3xl'>Talk to the Building Surveying team ...</span>
                  </div>
