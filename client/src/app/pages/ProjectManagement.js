...
import { project_management } from '../Data'
          ...
          <div key={index} className='relative'>
            ...
            <div className="">
              ...
              <div className="flex  -ml-[20rem] justify-center items-center">
                <div className="flex roles_res">
                  ...
                  <div className="relative ml-[5rem] mt-[5rem]">
                    <div className="w-[.2rem] h-[60rem] bg-[#D50036] mx-auto">
                      <div className="w-5 h-5 bg-[#D50036] rounded-full absolute top-0 left-1/2 transform -translate-x-1/2"></div>
                      <div className="w-5 h-5 bg-[#D50036] rounded-full absolute bottom-0 left-1/2 transform -translate-x-1/2"></div>
                    </div>
                  </div>
              ...
              <div className="w-full bg-[#d2ecf88a] ">
                <div className="flex -mt-[42rem] p-4 ml-[10rem]">
                  ...
                  <div className="ml-[15rem] mt-[58rem]">
                    <p className='w-full max-w-[30rem] res_Lpara_width text-xl lg:text-3xl text-[#D50036]'>
                    This list is not exhaustive lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.                    </p> <br />
                    <span className='text-[#D50036] cursor-pointer text-xl font-semibold mt-[2rem] lg:text-3xl'>Talk to the Project Management team ...</span>
                  </div>
